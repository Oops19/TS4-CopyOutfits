...
class _RegisterOutfitTools_Copy_Outfits_0(CommonScriptObjectInteractionHandler):
    ...
    def interactions_to_add(self) -> Tuple[int]:
        interactions: Tuple = (
            ...
            0xE7B5AF07D572C84E,  # 'Complete Outfit' - fnv('o19_Copy_Outfits_PMC__Copy_Outfits__Transfer_PMA_Complete_Outfit_debug')
            ...
            0xF1AF7A8B1F81D4F6,  # 'All' - fnv('o19_Copy_Outfits_PMC__Copy_Outfits__Transfer_PMA_All_debug')
            0x1295674F06E09A81,  # 'Age & Gender' - fnv('o19_Copy_Outfits_PMC__Copy_Outfits__Transfer_PMA_Age_x26_Gender_debug')
            0x6AF98600AED51218,  # 'Physics & Genetics' - fnv('o19_Copy_Outfits_PMC__Copy_Outfits__Transfer_PMA_Physics_x26_Genetics_debug')
            0x8C19A6EE2C58C4F1,  # 'Genetics' - fnv('o19_Copy_Outfits_PMC__Copy_Outfits__Transfer_PMA_Genetics_debug')
            # 0x3B4C63F6AE02FCB1,  # 'Sliders' - fnv('o19_Copy_Outfits_PMC__Copy_Outfits__Transfer_PMA_Sliders_debug')
            ...
            0x000B57AA1D5D8346,  # 'Outfit 0' - fnv('o19_Copy_Outfits_PMC__Copy_Outfits__Paste__to_PMA_Outfit_0_debug')
            0x273FF83BA8E25717,  # 'Outfit 1' - fnv('o19_Copy_Outfits_PMC__Copy_Outfits__Paste__to_PMA_Outfit_1_debug')
            0x231B25ADD594BB50,  # 'Outfit 2' - fnv('o19_Copy_Outfits_PMC__Copy_Outfits__Paste__to_PMA_Outfit_2_debug')
            0xB1471B78F81DDB11,  # 'Outfit 3' - fnv('o19_Copy_Outfits_PMC__Copy_Outfits__Paste__to_PMA_Outfit_3_debug')
            0x34DD20B83BFB23E2,  # 'Outfit 4' - fnv('o19_Copy_Outfits_PMC__Copy_Outfits__Paste__to_PMA_Outfit_4_debug')
